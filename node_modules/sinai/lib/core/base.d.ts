...
export interface Injected<SG, SGMA> {
    ...
    and<K extends string, S, G extends BG0, M extends BM0, A extends BA0>(key: K, module: Module<S, G, M, A>): Injected<SG & Record<K, GI<S, G>>, SGMA & Record<K, AI<S, G, M, A>>>;
}
...
export declare function inject<K extends string, S, G extends BG0, M extends BM0, A extends BA0>(key: K, module: Module<S, G, M, A>): Injected<Record<K, GI<S, G>>, Record<K, AI<S, G, M, A>>>;
