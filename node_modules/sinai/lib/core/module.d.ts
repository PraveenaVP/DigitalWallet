...
export interface Module<S, G extends BG0, M extends BM0, A extends BA0> {
    child<K extends string, S1, G1 extends BG0, M1 extends BM0, A1 extends BA0>(key: K, module: Module<S1, G1, M1, A1>): Module<S & Record<K, S1>, G & Record<K, G1>, M & Record<K, M1>, A & Record<K, A1>>;
}
